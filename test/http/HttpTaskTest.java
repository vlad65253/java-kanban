...
class HttpTaskTest {
    ...
    void getTask() throws IOException, InterruptedException {
        ...
        Task task3 = new Task(3, "task3", TaskStatus.NEW, "description3",
        ...
        List<Task> fromManager = manager.getTaskList();
    ...
    void testUpdateTask() throws IOException, InterruptedException {
        ...
        Task newTask1 = new Task(1, "task2", TaskStatus.IN_PROGRESS, "description2",
        ...
        assertEquals(200, response.statusCode());
        assertEquals(newTask1, manager.getTask(1), "Задача не совпадает.");
    }
    ...
    void testStatusCode406() throws IOException, InterruptedException {
        Task task1 = new Task(1, "task1", TaskStatus.NEW, "description1",
                LocalDateTime.of(2024, 8, 24, 15, 30), Duration.ofMinutes(15));
        Task newTask1 = new Task(2, "task2", TaskStatus.IN_PROGRESS, "description2",
                LocalDateTime.of(2024, 8, 24, 15, 30), Duration.ofMinutes(15));
        manager.createTask(task1);
