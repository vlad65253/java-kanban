...
class HttpEpicTest {
    ...
    void getEpic() throws IOException, InterruptedException {
        Epic epic1 = new Epic(1, "epic1", TaskStatus.NEW, "description1",
                LocalDateTime.of(2024, 8, 24, 10, 0),
                LocalDateTime.of(2024, 8, 24, 10, 15),
                Duration.ofMinutes(15));
        Epic epic2 = new Epic(2, "epic2", TaskStatus.NEW, "description2",
                LocalDateTime.of(2024, 8, 25, 10, 0),
                LocalDateTime.of(2024, 8, 25, 10, 15),
                Duration.ofMinutes(15));
        Epic epic3 = new Epic(3, "epic3", TaskStatus.NEW, "description3",
        ...
        List<Epic> fromManager = manager.getEpicList();
